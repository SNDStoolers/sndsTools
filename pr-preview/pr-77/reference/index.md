...
- [`snds_table()`](snds_table.md) : Requêtage d'une table Oracle (SNDS
  ou ORAUSER).
...
- [`COLNAMES_DCIR_KEYS`](COLNAMES_DCIR_KEYS.md) : Neufs clés de jointure
  du DCIR
- [`IS_PORTAIL`](IS_PORTAIL.md) : Environnement d'exécution de sndsTools
