...
Tout utilisateur peut être contributeur en faisant [une nouvelle issue](https://github.com/SNDStoolers/sndsTools/issues), [une pull request](https://github.com/SNDStoolers/sndsTools/pulls), ou en effectuant une revue sur une pull request existante. Le [guide de contribution](contribuer.html) détaille les différentes manières de contribuer. 
